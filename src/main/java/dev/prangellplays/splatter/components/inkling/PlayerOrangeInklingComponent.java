...
public class PlayerOrangeInklingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/orange_inkling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isInkling()) {
            boolean collidingWithOrangeInk = Splatter.isCollidingWithOrangeInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithOrangeInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithOrangeInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isInkling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    OrangeInksplosion inksplosion = new OrangeInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
