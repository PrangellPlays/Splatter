...
public class PlayerPinkInklingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/pink_inkling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isInkling()) {
            boolean collidingWithPinkInk = Splatter.isCollidingWithPinkInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithPinkInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithPinkInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isInkling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    PinkInksplosion inksplosion = new PinkInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
