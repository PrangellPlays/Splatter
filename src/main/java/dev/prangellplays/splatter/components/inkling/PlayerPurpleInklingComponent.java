...
public class PlayerPurpleInklingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/purple_inkling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isInkling()) {
            boolean collidingWithPurpleInk = Splatter.isCollidingWithPurpleInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithPurpleInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithPurpleInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isInkling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    PurpleInksplosion inksplosion = new PurpleInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
