...
public class PlayerYellowInklingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/yellow_inkling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isInkling()) {
            boolean collidingWithYellowInk = Splatter.isCollidingWithYellowInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithYellowInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithYellowInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isInkling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    YellowInksplosion inksplosion = new YellowInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
