...
public class PlayerRedOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/red_octoling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isOctoling()) {
            boolean collidingWithRedInk = Splatter.isCollidingWithRedInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithRedInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithRedInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    RedInksplosion inksplosion = new RedInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
