...
public class PlayerWhiteOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/white_octoling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isOctoling()) {
            boolean collidingWithWhiteInk = Splatter.isCollidingWithWhiteInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithWhiteInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithWhiteInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    WhiteInksplosion inksplosion = new WhiteInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
