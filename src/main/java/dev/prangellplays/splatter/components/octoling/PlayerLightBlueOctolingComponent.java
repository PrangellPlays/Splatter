...
public class PlayerLightBlueOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    ...
    private void sync() {
        SplatterComponents.LIGHT_BLUE_OCTOLING.sync(this.player);
    }
    ...
    private void correctOctoling() {
        boolean shouldBeOctoling = this.player.hasStatusEffect(SplatterStatusEffects.LIGHT_BLUE_INKSKIN);
    ...
    public void setDiving(boolean diving) {
        ...
        if (var4 instanceof ServerWorld serverWorld) {
            ...
            while(var9.hasNext()) {
                ...
                boolean isSplash = Splatter.isCollidingWithLightBlueInk(this.player);
    ...
    public void serverTick() {
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (Splatter.isCollidingWithLightBlueInk(this.player)) {
                    this.setOutOfInkTimer(0);
