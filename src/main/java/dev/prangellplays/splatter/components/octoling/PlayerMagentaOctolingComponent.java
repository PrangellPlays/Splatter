...
public class PlayerMagentaOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/magenta_octoling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isOctoling()) {
            boolean collidingWithMagentaInk = Splatter.isCollidingWithMagentaInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithMagentaInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithMagentaInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    MagentaInksplosion inksplosion = new MagentaInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
