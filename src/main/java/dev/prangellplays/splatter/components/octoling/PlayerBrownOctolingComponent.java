...
public class PlayerBrownOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/brown_octoling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isOctoling()) {
            boolean collidingWithBrownInk = Splatter.isCollidingWithBrownInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithBrownInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithBrownInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    BrownInksplosion inksplosion = new BrownInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), SplatterCommand.getInkSpreadPower());
                    inksplosion.tick();
