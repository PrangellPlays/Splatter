...
public class PlayerBlackOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier INKSKIN_TEXTURE = Splatter.id("textures/entity/inkskin/black_octoling_base.png");
    ...
    public void clientTick() {
        this.tick();
        if (this.isOctoling()) {
            boolean collidingWithBlackInk = Splatter.isCollidingWithBlackInk(this.player);
            if (this.isDiving()) {
                if (!collidingWithBlackInk && this.player.isOnGround()) {
            ...
            } else if (!collidingWithBlackInk && !this.player.isTouchingWater() && this.player.isOnGround()) {
