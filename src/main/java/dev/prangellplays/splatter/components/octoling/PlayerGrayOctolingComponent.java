            ...
            if (SplatterConfig.inkParticles) {
                if (this.isDiving()) {
                    if (!collidingWithFuneralInk && this.player.isOnGround()) {
                        this.player.getWorld().addParticle(SplatterParticles.GRAY_INK_SPLAT, (double) ((float) this.player.getX()), (double) ((float) this.player.getY() + 0.01F), (double) ((float) this.player.getZ()), 0.0, 0.0, 0.0);
                    }
