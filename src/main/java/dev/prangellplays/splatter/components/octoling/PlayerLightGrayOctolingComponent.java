...
public class PlayerLightGrayOctolingComponent implements AutoSyncedComponent, CommonTickingComponent {
    public static final Identifier OCTOLING_TEXTURE = Splatter.id("textures/entity/octoling/light_gray_octoling_base.png");
        ...
        if (this.isOctoling()) {
            ...
            if (this.isDiving()) {
                ...
                if (this.isMovingWhileDiving()) {
                    LightGrayInksplosion inksplosion = new LightGrayInksplosion(this.player.getWorld(), this.player, this.player.getX(), this.player.getY(), this.player.getZ(), 1.0F);
                    inksplosion.tick();
    ...
    public enum Type {
        DEFAULT("default", false, (String)null, "textures/entity/octoling/light_gray_octoling_crown_base");
