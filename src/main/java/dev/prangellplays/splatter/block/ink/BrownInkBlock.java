...
public class BrownInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public BrownInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(BrownInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.BROWN_INK.asItem()) || super.canReplace(state, context);
    }
