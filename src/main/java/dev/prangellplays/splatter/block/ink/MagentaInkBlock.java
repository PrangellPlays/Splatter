...
public class MagentaInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public MagentaInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(MagentaInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.MAGENTA_INK.asItem()) || super.canReplace(state, context);
    }
