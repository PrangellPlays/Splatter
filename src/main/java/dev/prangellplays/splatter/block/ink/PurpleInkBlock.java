...
public class PurpleInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public PurpleInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(PurpleInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.PURPLE_INK.asItem()) || super.canReplace(state, context);
    }
