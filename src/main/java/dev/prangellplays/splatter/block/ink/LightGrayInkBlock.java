...
public class LightGrayInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public LightGrayInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(LightGrayInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.LIGHT_GRAY_INK.asItem()) || super.canReplace(state, context);
    }
