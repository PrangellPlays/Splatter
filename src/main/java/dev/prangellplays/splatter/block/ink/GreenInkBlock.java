...
import dev.prangellplays.splatter.components.inkling.PlayerGreenInklingComponent;
...
public class GreenInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public GreenInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(GreenInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.GREEN_INK.asItem()) || super.canReplace(state, context);
    }
