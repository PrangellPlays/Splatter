...
public class GrayInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public GrayInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(GrayInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.GRAY_INK.asItem()) || super.canReplace(state, context);
    }
