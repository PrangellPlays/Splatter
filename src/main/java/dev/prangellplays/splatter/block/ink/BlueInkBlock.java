...
public class BlueInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public BlueInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(BlueInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.BLUE_INK.asItem()) || super.canReplace(state, context);
    }
