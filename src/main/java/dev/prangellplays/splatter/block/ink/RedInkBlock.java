...
public class RedInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public RedInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(RedInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.RED_INK.asItem()) || super.canReplace(state, context);
    }
