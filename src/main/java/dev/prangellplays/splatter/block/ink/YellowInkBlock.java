...
import dev.prangellplays.splatter.components.inkling.PlayerYellowInklingComponent;
...
public class YellowInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public YellowInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(YellowInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.YELLOW_INK.asItem()) || super.canReplace(state, context);
    }
