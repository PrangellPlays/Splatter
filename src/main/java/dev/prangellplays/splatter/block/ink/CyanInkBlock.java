...
import dev.prangellplays.splatter.components.inkling.PlayerCyanInklingComponent;
...
public class CyanInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public CyanInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(CyanInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.CYAN_INK.asItem()) || super.canReplace(state, context);
    }
