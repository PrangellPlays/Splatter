...
import dev.prangellplays.splatter.components.inkling.PlayerOrangeInklingComponent;
...
public class OrangeInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public OrangeInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(OrangeInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.ORANGE_INK.asItem()) || super.canReplace(state, context);
    }
