...
import dev.prangellplays.splatter.components.octoling.PlayerLightBlueOctolingComponent;
...
public class LightBlueInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public LightBlueInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(LightBlueInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.LIGHT_BLUE_INK.asItem()) || super.canReplace(state, context);
    }
