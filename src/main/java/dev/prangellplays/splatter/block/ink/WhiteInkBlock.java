...
public class WhiteInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public WhiteInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(WhiteInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.WHITE_INK.asItem()) || super.canReplace(state, context);
    }
