...
public class BlackInkBlock extends MultifaceGrowthBlock implements Waterloggable {
    ...
    public BlackInkBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState((BlockState)this.getDefaultState().with(WATERLOGGED, false));
        this.SHAPES = this.getShapesForStates(BlackInkBlock::getShapeForState);
    }
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        return !context.getStack().isOf(SplatterBlocks.BLACK_INK.asItem()) || super.canReplace(state, context);
    }
