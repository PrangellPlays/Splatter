...
public class BrownInkSplatParticle extends HorizontalSpriteParticle {
    public BrownInkSplatParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (FallingBlock.canFallThrough(state) || Splatter.isABrownInkFacingDown(state)) {
            this.markDead();
        }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            BrownInkSplatParticle particle = new BrownInkSplatParticle(world, x, y, z);
