...
public class CyanInkSplatParticle extends HorizontalSpriteParticle {
    public CyanInkSplatParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (FallingBlock.canFallThrough(state) || Splatter.isACyanInkFacingDown(state)) {
            this.markDead();
        }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            CyanInkSplatParticle particle = new CyanInkSplatParticle(world, x, y, z);
