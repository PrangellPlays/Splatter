...
public class YellowFallingInkParticle extends SpriteBillboardParticle {
    public YellowFallingInkParticle(ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            YellowFallingInkParticle particle = new YellowFallingInkParticle(world, x, y, z, velocityX, velocityY, velocityZ);
