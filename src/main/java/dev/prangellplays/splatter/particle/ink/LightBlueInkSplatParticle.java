...
public class LightBlueInkSplatParticle extends HorizontalSpriteParticle {
    public LightBlueInkSplatParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (FallingBlock.canFallThrough(state) || Splatter.isALightBlueInkFacingDown(state)) {
            this.markDead();
        }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            LightBlueInkSplatParticle particle = new LightBlueInkSplatParticle(world, x, y, z);
