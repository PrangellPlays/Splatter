...
public class PurpleInkSplatParticle extends HorizontalSpriteParticle {
    public PurpleInkSplatParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (FallingBlock.canFallThrough(state) || Splatter.isAPurpleInkFacingDown(state)) {
            this.markDead();
        }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            PurpleInkSplatParticle particle = new PurpleInkSplatParticle(world, x, y, z);
