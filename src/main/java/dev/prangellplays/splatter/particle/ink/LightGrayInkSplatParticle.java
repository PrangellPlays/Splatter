...
public class LightGrayInkSplatParticle extends HorizontalSpriteParticle {
    public LightGrayInkSplatParticle(ClientWorld clientWorld, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (FallingBlock.canFallThrough(state) || Splatter.isALightGrayInkFacingDown(state)) {
            this.markDead();
        }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public @Nullable Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            LightGrayInkSplatParticle particle = new LightGrayInkSplatParticle(world, x, y, z);
